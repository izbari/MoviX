import {ADD_TO_FAVORITE_LIST_SUCCESS,ADD_TO_FAVORITE_LIST_FAILURE,REMOVE_TO_FAVORITE_LIST} from './actions';
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case ADD_TO_FAVORITE_LIST_FAILURE: {
      Toast("Can't add to favorite list");
      return state;
    }
